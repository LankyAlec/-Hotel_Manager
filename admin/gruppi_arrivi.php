                        ...
                        <?php foreach ($records as $record): ?>
                            <?php
                                ...
                                $dettaglioPartecipanti = $totale > 0
                                    ...
                                    : '0';
                                $trattamento = !empty($record['trattamento']) ? $record['trattamento'] : '—';
                                $areeRiservate = !empty($record['aree_riservate']) || !empty($record['area_preferita']) ? 'Sì' : 'No';
                            ?>
                            <tr>
