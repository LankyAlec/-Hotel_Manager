...
<head>
    ...
    <!-- Bootstrap JS (necessario per dropdown, modals, ecc.)
         CDN + fallback locale (utile su NAS senza accesso esterno).
         Se vuoi il fallback, salva il file qui:
         <?= BASE_URL ?>/assets/vendor/bootstrap/bootstrap.bundle.min.js
    -->
    <script>
      (function(){
        ...
        load('https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js', function(){
          // fallback locale
          load('<?= BASE_URL ?>/assets/vendor/bootstrap/bootstrap.bundle.min.js');
        });
      })();
    </script>
