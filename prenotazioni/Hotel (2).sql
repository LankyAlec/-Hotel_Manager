...
--
-- Host: localhost
-- Creato il: Gen 19, 2026 alle 19:31
...
(10, 'Castello 33 Cl', NULL, 4, 'pz', 1, '2026-01-19 18:22:20', NULL);
...
CREATE TABLE `soggiorni` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `prenotazione_id` bigint(20) UNSIGNED DEFAULT NULL,
  `camera_id` int(10) UNSIGNED NOT NULL,
...
INSERT INTO `soggiorni` (`id`, `prenotazione_id`, `camera_id`, `data_checkin`, `data_checkout`, `stato`, `piano_pasto_sigla`, `hb_servizio`, `note`, `created_at`, `updated_at`) VALUES
(1, NULL, 55, '2026-01-19', '2026-01-20', 'prenotato', 'BB', 'CENA', NULL, '2026-01-15 13:24:42', '2026-01-15 13:24:42'),
(2, NULL, 58, '2026-01-19', '2026-01-24', 'prenotato', 'BB', 'CENA', NULL, '2026-01-15 16:56:22', '2026-01-15 16:56:22'),
(3, NULL, 55, '2026-01-21', '2026-01-25', 'prenotato', 'BB', 'CENA', NULL, '2026-01-15 17:00:11', '2026-01-15 17:00:11'),
(4, NULL, 55, '2026-02-02', '2026-02-20', 'prenotato', 'BB', 'CENA', NULL, '2026-01-16 19:09:22', '2026-01-16 19:09:22'),
(5, NULL, 58, '2026-01-25', '2026-01-30', 'prenotato', 'BB', 'CENA', NULL, '2026-01-18 20:12:08', '2026-01-18 20:12:08'),
(6, NULL, 60, '2026-01-26', '2026-01-30', 'prenotato', 'BB', 'CENA', NULL, '2026-01-18 20:14:16', '2026-01-18 20:14:16'),
(7, NULL, 61, '2026-01-22', '2026-01-27', 'prenotato', 'BB', 'CENA', NULL, '2026-01-18 20:17:13', '2026-01-18 20:17:13');
...
CREATE TABLE `soggiorni_tariffe` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `piano_tariffario_id` int(10) UNSIGNED NOT NULL,
  `camera_id` int(10) UNSIGNED NOT NULL,
...
(1, 4, 7, 56, '1111', NULL, 'MEDIA', 'APERTO', NULL, 1, NULL, '2026-01-11 12:10:48', NULL);
...
(1, 'alessio', 'alessio.patamia@gmail.com', '$2a$12$a3Nd6gUMG6JT2pC4ENyYlujlTltyE8takVCNZAVPS/vyrn5bVXcnG', 'Alessio', 'Patamia', NULL, 'root', 1, 0, NULL, NULL, NULL, NULL, '2026-01-19 08:52:56', '2025-12-13 16:51:13', '2026-01-19 08:52:56'),
...
ALTER TABLE `soggiorni`
  ...
  ADD KEY `fk_sogg_pren` (`prenotazione_id`);
...
ALTER TABLE `soggiorni_tariffe`
  ADD PRIMARY KEY (`id`),
  ADD KEY `piano_tariffario_id` (`piano_tariffario_id`),
...
ALTER TABLE `soggiorni`
  ...
  ADD CONSTRAINT `fk_sogg_pren` FOREIGN KEY (`prenotazione_id`) REFERENCES `prenotazioni` (`id`) ON DELETE SET NULL;
...
--
-- Limiti per la tabella `soggiorni_tariffe`
--
ALTER TABLE `soggiorni_tariffe`
  ADD CONSTRAINT `soggiorni_tariffe_ibfk_1` FOREIGN KEY (`piano_tariffario_id`) REFERENCES `piani_tariffari` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `soggiorni_tariffe_ibfk_2` FOREIGN KEY (`camera_id`) REFERENCES `struttura_camere` (`id`) ON DELETE CASCADE;
