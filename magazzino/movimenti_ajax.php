...
/* =========================
 * OPERATORE (ID UTENTE LOGGATO)
 * ======================= */
$operatore_id = (int)($_SESSION['utente_id'] ?? 0);
if ($method === 'POST' && $operatore_id <= 0) {
  json_out(['ok'=>false, 'html'=>'<div class="alert alert-danger mb-0">Sessione scaduta: effettua di nuovo il login.</div>']);
}
